<?php 
class sa_add_pj extends admin_controller{
	var $controller;
	function sa_add_pj(){
		parent::__construct();
...
function index(){
		...
		$this->set_subtitle("Data Penanggungjawab");
		$this->set_title("Data Penanggungjawab");
...
function baru(){
        ...
        $this->set_subtitle("Tambah Penanggungjawab");
        $this->set_title("Tambah Penanggungjawab");
        $this->set_content($content);
        $this->cetak();
}
...
function simpan(){
    ...
    $post = $this->input->post();
        ...
        $this->form_validation->set_rules('BADAN_USAHA','Nama Badan Usaha','required'); 
        $this->form_validation->set_rules('ALAMAT','Alamat Penanggungjawab','required');   
...
if($this->form_validation->run() == TRUE ) { 
    ...
    function editdata(){
		...
		$this->set_subtitle("Edit Penanggungjawab");
		$this->set_title("Edit Penanggungjawab");
		$this->set_content($content);
		$this->cetak();
